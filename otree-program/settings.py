...
SESSION_CONFIGS = [
                ...
                dict(name='bank2', display_name='bank2', num_demo_participants=2, app_sequence=['bank2_instruction_part1','bank2_practice','bank2_instruction_part2','bank2_game_70d','bret'])
                ]
LANGUAGE_CODE = 'en'
